-- MLBB MPL Database Setup - Safe Version (handles existing types)
-- Run this in your Supabase project's SQL Editor

-- Enable necessary extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Create custom types for MLBB (only if they don't exist)
DO $$ 
BEGIN
    ...
    -- Create hero_role enum if it doesn't exist
...
INSERT INTO teams (team_name, team_code, founded_year, coach_name) VALUES
('EVOS Legends', 'EVOS', 2017, 'Zeys'),
('RRQ Hoshi', 'RRQ', 2013, 'Lemon'),
('ONIC Esports', 'ONIC', 2018, 'Kabuki'),
('Alter Ego', 'AE', 2020, 'Lucky'),
('Bigetron Alpha', 'BTR', 2018, 'Lucky'),
('Todak', 'TODAK', 2017, 'MobaZane'),
('Team Secret', 'TS', 2017, 'MobaZane'),
('RSG MY', 'RSG', 2019, 'MobaZane'),
('Bren Esports', 'BREN', 2017, 'MobaZane'),
('Blacklist International', 'BLCK', 2019, 'MobaZane')
